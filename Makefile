...
ARCH		?=arm
CROSS_COMPILE	?=../../../toolchains/linaro-arm-eabi-4.10/bin/arm-eabi-
...
KBUILD_CFLAGS	+= -O3 $(call cc-disable-warning,maybe-uninitialized,array-bounds,) -fno-inline-functions
endif
